...
+function () {
    ...
    var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (a) {
        ...
        var d = "datetimepicker", f = "5.0.0-alpha12", g = "" + d, h = "." + g, i = g + ".", j = ".data-api", k = {DATA_TOGGLE: '[data-toggle="' + g + '"]'}, l = {INPUT: d + "-input"}, m = {
            CHANGE: "change" + h,
            BLUR: "blur" + h,
            KEYUP: "keyup" + h,
            KEYDOWN: "keydown" + h,
            ...
            HIDE: i + "hide",
            SHOW: i + "show"
        }, n = [{CLASS_NAME: "days", NAV_FUNCTION: "M", NAV_STEP: 1}, {CLASS_NAME: "months", NAV_FUNCTION: "y", NAV_STEP: 1}, {
            CLASS_NAME: "years",
            NAV_FUNCTION: "y",
            NAV_STEP: 10
        }, {CLASS_NAME: "decades", NAV_FUNCTION: "y", NAV_STEP: 100}], o = {
            up: 38,
            38: "up",
            down: 40,
            40: "down",
            ...
            return i.prototype._int = function () {
                ...
                "y" === a && (a = "YYYY"), this._notifyEvent({type: i.Event.UPDATE, change: a, viewDate: this._viewDate.clone()})
    ...
    (function (e) {
        var g = e.fn[f.NAME], h = ["top", "bottom", "auto"], i = ["left", "right", "auto"], j = ["default", "top", "bottom"], k = function (a) {
            ...
            return b(k, g), k.prototype._init = function () {
                ...
                var a = e("<div>").addClass("timepicker-hours").append(e("<table>").addClass("table-condensed")),
                    ...
                    c = e("<div>").addClass("timepicker-seconds").append(e("<table>").addClass("table-condensed")), d = [this._getTimePickerMainTemplate()];
                ...
                var a = e("<div>").addClass("bootstrap-datetimepicker-widget dropdown-menu"), b = e("<div>").addClass("datepicker").append(this._getDatePickerTemplate()),
                    c = e("<div>").addClass("timepicker").append(this._getTimePickerTemplate()), d = e("<ul>").addClass("list-unstyled"),
                ...
                var b = a && a.data && a.data.picker || this, c = b._options.widgetPositioning.vertical, d = b._options.widgetPositioning.horizontal, f = void 0,
                    g = (b.component || b._element).position(), h = (b.component || b._element).offset();
                ...
                var a = this.widget.find(".datepicker-years"), b = a.find("th"), c = this._getStartEndYear(10, this._viewDate.year()), d = this._viewDate.clone().year(c[0]),
                ...
                var a = this.widget.find(".datepicker-decades"), b = a.find("th"), c = this._getStartEndYear(100, this._viewDate.year()), d = this._viewDate.clone().year(c[0]),
                ...
                switch (b = b || e(a.currentTarget).data("action")) {
                    ...
                    case"togglePeriod":
                        ...
                        break;
                    case"togglePicker":
                        var r = e(a.target), s = r.closest("a"), t = r.closest("ul"), u = t.find(".show"), v = t.find(".collapse:not(.show)"), w = r.is("span") ? r : r.find("span"), x = void 0;
                        if (u && u.length) {
