...
(function (a) {
        ...
        _constructor: function () {
            ...
            a(e.table().container()).on("mousedown.rowReorder touchstart.rowReorder", this.c.selector, function (b) {
                if (c.c.enable) {
                    ...
                    if (n.any()) return c._emitEvent("pre-row-reorder", {node: n.node(), index: n.index()}), c._mouseDown(b, d), !1
                }
            });
            ...
            var c = this.s.dt, e = a(c.table().node()).find("thead").outerHeight(), b = a.unique(c.rows({page: "current"}).nodes().toArray()), n = a.map(b, function (c, b) {
            ...
            var e =
                    a(this.s.dt.table().node().cloneNode(!1)).addClass("dt-rowReorder-float").append("<tbody/>").append(c.clone(!1)), b = c.outerWidth(), n = c.outerHeight(),
            ...
            var h = this.s.start.nodes, l = a.unique(b.rows({page: "current"}).nodes().toArray()), m = {}, q = [], p = [], r = this.s.getDataFn, y = this.s.setDataFn;
            var k = 0;
    ...
    m.defaults = {dataSrc: 0, editor: null, enable: !0, formOptions: {}, selector: "td:first-child", snapX: !1, update: !0, excludedChildren: "a"};
