    ...
    d.extend(i.prototype, {
        _constructor: function () {
            ...
            e.each(function (a, e) {
                for (var c = a.className.split(" "), f = !1, i = 0, l = c.length; i < l; i++) {
                    ...
                    d.each(b, function (a, b) {
                        var d = b.name.split("-"), c = j.match(RegExp("(min\\-|max\\-|not\\-)?(" + d[0] + ")(\\-[_a-zA-Z0-9])?"));
            ...
            if (this.c.auto && -1 !== d.inArray(!0, d.map(b, function (a) {
                ...
                a.table().node();
                var c = a.table().node().cloneNode(!1), e = d(a.table().header().cloneNode(!1)).appendTo(c), f = d(a.table().body()).clone(!1, !1).empty().appendTo(c),
